		...
		?>
			<table border="1" cellpadding="0" cellspacing="0">
    			<tr>
            		...
            		<th style="width: 250px"><a href="themdanhmuc.php">Thêm</a></th>
        		</tr>
            <?php
            ...
            ?>
                ...
                <td><a href="xoadm.php?id=<?php echo($dm["ma"]);?>" onclick="return confirm('Ban co chac chan muon xoa khong?');">Xóa</a></td>
                <td><a href="suadm.php?maLoaisp=<?php echo($dm["ma"]);?>">Sửa</a></td>
            </tr>
            <?php   
            }
            ?>
