...
<html lang="en">
    ...
    <body>
		...
		//b2.1:viet cau query
			$sql="SELECT * FROM tblhoadon INNER JOIN tblhoadonchitiet ON tblhoadon.maHd = tblhoadonchitiet.maHd";
		//b2.2:chay cau query
			$result=mysqli_query($con,$sql);
		?>
			<div class="table-users">
                <div class="header">Quản lý hóa đơn</div>
                 
                <table cellspacing="0">
    			<tr>
        			<th style="width: 150px">Mã HD</th>
            		<th style="width: 100px">Tênngườinhận</th>
            		<th style="width: 100px">Địachỉngườinhận</th>
            		<th style="width: 100px">SĐT</th>
            		<th style="width: 100px">Ngàyđặt</th>
            		<th style="width: 100px">Tênsảnphẩm</th>
            		<th style="width: 100px">SL</th>
            		<th style="width: 100px">Tổng tiền</th>
            		<th style="width: 100px">Tìnhtrạng</th>
            		<th style="width: 100px"></th>
            		<th style="width: 250px"><a href="themhoadon.php">Thêm</a></th>
        		</tr>
            <?php
            ...
            ?>
           	 <tr>
            	<td><?php echo($hd["tblhoahon.maHd"])?></td>
                <td><?php echo($hd["tblhoadon.tenKhnhan"])?></td>
                <td><?php echo($hd["tblhoadon.diaChinhan"])?></td>
                <td><?php echo($hd["tblhoadon.sdtnhan"])?></td>
                <td><?php echo($hd["tblhoadon.ngaydathang"])?></td>
                <td><?php echo($hd["tblhoadonchitiet.maSp"])?></td>
                <td><?php echo($hd["tblhoadonchitiet.soLuong"])?></td>
                <td><?php echo($hd["tblhoadonchitiet.tongTien"]="soLuong"*"gia")?></td>
                <td><?php if ($hd["tblhoadon.tinhTrang"]==0) echo "Chờ duyệt đơn";
                			else if ($hd["tblhoadon.tinhTrang"]==1) echo "X/n thành công";
                			else if ($hd["tblhoadon.tinhTrang"]==2) echo "Hủy";
                            else if ($hd["tblhoadon.tinhTrang"]==4) echo "Giao hàng thành công";
                			else echo "Đang giao";?></td>
                <td><a href="xoahd.php?id=<?php echo($hd["tblhoahon.maHd"]);?>" onclick="return confirm('Ban co chac chan muon xoa khong?');">Xóa</a></td>
                <td><a href="suahd.php?maHd=<?php echo($hd["tblhoahon.maHd"]);?>">Sửa</a></td>
            </tr>
            <?php   
            }
            ?>
