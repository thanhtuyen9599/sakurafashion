    ...
    <body>
		...
		?>
			<table border="1" cellpadding="0" cellspacing="0">
    			<tr>
        			<th style="width: 250px">Mã loại SP</th>
          	  		<th style="width: 550px">Tên loại SP</th>
                    <th style="width: 250px">Danh mục</th>
            		<th style="width: 350px"><a href="themloaisanpham.php">Thêm loại SP</a></th>
        		</tr>
       	 <?php
			...
			?>
           	 <tr>
            	<td><?php echo($loaisp["maLoaisp"]);?></td>
                <td><?php echo($loaisp["tenLoaisp"]);?></td>
                <td><?php if ($loaisp["ma"]==1) echo "Áo";
                            else if($loaisp["ma"]==3) echo "Váy đầm";
                            else echo "Quần"; ?></td>
                <td><a href="sualoaisp.php?maLoaisp=<?php echo($loaisp["maLoaisp"]);?>">Sửa</a></td>
            </tr>
            <?php	
			}
			?>
