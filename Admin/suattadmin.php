...
<html lang="en">
    <head>
        ...
        <style>
			...
			#tt {position: absolute; top:130px; left:530px; color:#C00}
        </style>
    </head>
	...
	if(isset($_GET["maTK"]))
	{
		...
		$sql="select * from tbladmin where maTK='$id'";
		$result=mysqli_query($con,$sql);
		$id=mysqli_fetch_array($result);
		?>
        <form action="suattadminprocess.php" enctype="multipart/form-data" method="post">
        	<table>
        		<div id="tt"><h3>Sửa thông tin admin</h3></div>
              <tr>
              ...
              <tr>
       			<th>Avt:<input type="file" name="txtanh" value="<?php echo($id["anh"]);?>" /><br /></th>
              </tr>
              <tr>
