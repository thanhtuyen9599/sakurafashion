...
<html lang="en">
	...
	<form action="themkhprocess.php" enctype="multipart/form-data" method="post">
    	<table>
    			<div id="tt"><h3>Thêm khách hàng</h3></div>
        	<tr>
    			<th>Tên đăng nhập:<input type="text" name="txtuser" /><br /></th>
            </tr>
            <tr>
        		<th>Password:<input type="text" name="txtpass" /><br /></th>
             </tr>
            <tr>
        		<th>Họ và tên:<input type="text" name="txtten" /><br /></th>
            </tr>
            <tr>
        		<th>Địa chỉ:<input type="text" name="txtadd" /><br /></th>
            <tr>
        		<th>SĐT:<input type="text" name="txtsdt" /><br /></th>
            </tr>
            <tr>
        		<th>Giới tính:<input type="radio" name="rdbGt" value="1" />Nam
        			<input type="radio" name="rdbGt" value="0" />Nữ<br /></th>
            </tr>
            <tr>
        		<th>Ngày sinh:<input type="date" name="txtdob"/><br/></th>
            </tr>
            <tr>
        		<th>Email:<input type="text" name="txtemail"/><br/></th>
            </tr>
        <?php
		//mo ket noi
		include("../ConnectDb/open.php");
