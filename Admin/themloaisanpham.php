...
<html lang="en">
	...
	<form action="themloaisanphamprocess.php">
    	<table>
        		<div id="tt"><h3>Thêm loại sản phẩm</h3></div>
        	<tr>
    			<th>Tên loại SP:<input type="text" name="txtTen" /><br /></th>
             </tr>
             <tr>
        	<th>Danh mục:<select name="danhmuc"> <br />
