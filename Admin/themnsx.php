...
<html lang="en">
	...
	<form action="themnsxprocess.php">
    <table>
    		<div id="tt"><h3>Thêm nhà sản xuất</h3></div>
    	<tr>
    		<th>Tên NSX:<input type="text" name="txtTen" /><br /></th>
        </tr>
        <tr>
        	<th>Địa chỉ:<input type="text" name="txtDiachi" /><br /></th>
         </tr>
         <tr>
